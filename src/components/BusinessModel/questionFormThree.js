...
class questiionFormThree extends Component {
  state = {
    title: "",
    question: "",
    selectedOption: "",
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      title: data[2].title,
      question: data[2]._id,
      answer1: data[2].answers[0].answer,
      answer2: data[2].answers[1].answer,
      answer3: data[2].answers[2].answer,
      answer4: data[2].answers[3].answer,
      answer1ID: data[2].answers[0]._id,
      answer2ID: data[2].answers[1]._id,
      answer3ID: data[2].answers[2]._id,
      answer4ID: data[2].answers[3]._id,
    });
  };
  ...
  handleFormSubmit = async (e) => {
    ...
    localStorage.setItem("answer3", subAnswers.answer);

    localStorage.setItem("question3", question);
    localStorage.setItem("question3Answer", selectedOption);
    window.location = "/questionFour";
  };
...
export default questiionFormThree;

...
class questiionFormSix extends Component {
  state = {
    title: "",
    question: "",
    selectedOption: "",
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      title: data[5].title,
      question: data[5]._id,
      answer1: data[5].answers[0].answer,
      answer2: data[5].answers[1].answer,
      answer3: data[5].answers[2].answer,
      answer4: data[5].answers[3].answer,
      answer1ID: data[5].answers[0]._id,
      answer2ID: data[5].answers[1]._id,
      answer3ID: data[5].answers[2]._id,
      answer4ID: data[5].answers[3]._id,
    });
  };
  ...
  handleFormSubmit = async (e) => {
    ...
    localStorage.setItem("title6", title);
    localStorage.setItem("answer6", subAnswers.answer);

    localStorage.setItem("question6", question);
    localStorage.setItem("question6Answer", selectedOption);
    window.location = "/questionSeven";
  };
...
export default questiionFormSix;

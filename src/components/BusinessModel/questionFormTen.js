...
class questiionFormTen extends Component {
  state = {
    title: "",
    question: "",
    selectedOption: "",
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      title: data[9].title,
      question: data[9]._id,
      answer1: data[9].answers[0].answer,
      answer2: data[9].answers[1].answer,
      answer3: data[9].answers[2].answer,
      answer4: data[9].answers[3].answer,
      answer1ID: data[9].answers[0]._id,
      answer2ID: data[9].answers[1]._id,
      answer3ID: data[9].answers[2]._id,
      answer4ID: data[9].answers[3]._id,
    });
  };
  ...
  handleFormSubmit = async (e) => {
    ...
    localStorage.setItem("title10", title);
    localStorage.setItem("answer10", subAnswers.answer);

    localStorage.setItem("question10", question);
    localStorage.setItem("question10Answer", selectedOption);
...
export default questiionFormTen;

...
class questiionFormNine extends Component {
  state = {
    title: "",
    question: "",
    selectedOption: "",
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      title: data[8].title,
      question: data[8]._id,
      answer1: data[8].answers[0].answer,
      answer2: data[8].answers[1].answer,
      answer3: data[8].answers[2].answer,
      answer4: data[8].answers[3].answer,
      answer1ID: data[8].answers[0]._id,
      answer2ID: data[8].answers[1]._id,
      answer3ID: data[8].answers[2]._id,
      answer4ID: data[8].answers[3]._id,
    });
  };
  ...
  handleFormSubmit = async (e) => {
    ...
    localStorage.setItem("title9", title);
    localStorage.setItem("answer9", subAnswers.answer);

    localStorage.setItem("question9", question);
    localStorage.setItem("question9Answer", selectedOption);
    window.location = "/questionTen";
  };
...
export default questiionFormNine;

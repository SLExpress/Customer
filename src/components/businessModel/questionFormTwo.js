...
class questiionFormTwo extends Component {
  state = {
    title: "",
    question: "",
    selectedOption: "",
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      title: data[1].title,
      question: data[1]._id,
      answer1: data[1].answers[0].answer,
      answer2: data[1].answers[1].answer,
      answer3: data[1].answers[2].answer,
      answer4: data[1].answers[3].answer,
      answer1ID: data[1].answers[0]._id,
      answer2ID: data[1].answers[1]._id,
      answer3ID: data[1].answers[2]._id,
      answer4ID: data[1].answers[3]._id,
    });
  };
  ...
  handleFormSubmit = async (e) => {
    ...
    localStorage.setItem("answer2", subAnswers.answer);

    localStorage.setItem("question2", question);
    localStorage.setItem("question2Answer", selectedOption);
    window.location = "/questionThree";
  };
...
export default questiionFormTwo;

...
class questiionFormEight extends Component {
  state = {
    title: "",
    question: "",
    selectedOption: "",
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      title: data[7].title,
      question: data[7]._id,
      answer1: data[7].answers[0].answer,
      answer2: data[7].answers[1].answer,
      answer3: data[7].answers[2].answer,
      answer4: data[7].answers[3].answer,
      answer1ID: data[7].answers[0]._id,
      answer2ID: data[7].answers[1]._id,
      answer3ID: data[7].answers[2]._id,
      answer4ID: data[7].answers[3]._id,
    });
  };
  ...
  handleFormSubmit = async (e) => {
    ...
    localStorage.setItem("title8", title);
    localStorage.setItem("answer8", subAnswers.answer);

    localStorage.setItem("question8", question);
    localStorage.setItem("question8Answer", selectedOption);
    window.location = "/questionNine";
  };
...
export default questiionFormEight;

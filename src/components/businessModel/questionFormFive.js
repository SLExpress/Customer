...
class questiionFormFive extends Component {
  state = {
    title: "",
    question: "",
    selectedOption: "",
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      title: data[4].title,
      question: data[4]._id,
      answer1: data[4].answers[0].answer,
      answer2: data[4].answers[1].answer,
      answer3: data[4].answers[2].answer,
      answer4: data[4].answers[3].answer,
      answer1ID: data[4].answers[0]._id,
      answer2ID: data[4].answers[1]._id,
      answer3ID: data[4].answers[2]._id,
      answer4ID: data[4].answers[3]._id,
    });
  };
  ...
  handleFormSubmit = async (e) => {
    ...
    localStorage.setItem("answer5", subAnswers.answer);

    localStorage.setItem("question5", question);
    localStorage.setItem("question5Answer", selectedOption);
    window.location = "/questionSix";
  };
...
export default questiionFormFive;
